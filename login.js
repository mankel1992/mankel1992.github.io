function openModal() {
    ...
    confirmMyInput.onkeyup = function() {
                ...
                console.log(confirmMyInput.value==myInput.value)
                console.log(myInput.value)
                console.log(confirmMyInput.value)
...
function enableButton(letter, capital, number, length, match) {
    ...
    var condition = (length.classList[0]=="valid"  & number.classList[0]=="valid" & letter.classList[0]=="valid" & capital.classList[0]=="valid"); // TODO: Replace false with the correct condition
    if(condition) {       
